...
\begin{requirements}
	...
	\req{NF120} Das Spiel bietet Langzeitmotivation (vgl. Erfolgesystem).
	\req{NF130} Das Spiel ist für die Nutzung durch mehrere Personen ausgelegt (Geschwister, Betreuer etc.).
	\req{NF140} Die Navigation durch das Spiel ist intuitiv, sowohl für Kinder als auch Erwachsene. Dies wird während ab der Implementierungsphase regelmäßig, d.h. mindestens dreiwöchig, durch externe Tester aus den jeweiligen Altersgruppen sichergestellt.
	\req{NF150} Das Spiel ist insgesamt kindgerecht entworfen, d.h.:
		\begin{itemize}
...
\begin{requirements}
	\req{NF210} Die Bedienung des Spiels verläuft insgesamt frustrationsfrei. Dies wird während ab der Implementierungsphase regelmäßig, d.h. mindestens dreiwöchig, durch externe Tester aus den jeweiligen Altersgruppen sichergestellt.
	...
	\req{NF231} * Eventuelle Wartezeiten werden für den Nutzer interessant gestaltet (Trivia, Animationen).
	\req{NF240} Die Simulation und deren Animationen verlaufen auf aktueller Hardware flüssig.
	\req{NF250} Es wird auf immer wiederkehrende Animationen, die den Spielfluss unterbrechen, verzichtet.
	\req{NF260} Das Spiel läuft stabil; es gilt:
		\begin{itemize}
