...
\begin {requirements}
	...
	\req[Ladebalken]{F410+} Bei Ladezeiten länger als eine Sekunde wird dem Spieler der Ladefortschritt durch einen Ladebalken dargestellt.
	\req [Ladebalken]{F420+} Bei Ladezeiten länger als fünf Sekunden  wird dem Spieler der Ladefortschritt durch einen Ladebalken dargestellt.
	\req[Krokodil-Trivia]{F430+} Beim Laden des Level werden dem Spieler lustige und interessante Fakten über Krokodile angezeigt.
	\req[Levelstand] {F440+} Das Spiel merkt sich den Stand innerhalb eines Levels beim Verlassen der Spielmodi und kann diesen beim erneuten Öffnen wiederherstellen.
\end {requirements}
