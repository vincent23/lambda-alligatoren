...
\begin{requirements}
	...
	\req [Spielerprofile Hinzufügen]{F111+} Spielerprofile werden einzeln hinzugefügt, dabei werden zunächst der Name und 	dann der Avartar ausgewählt.
...
\begin{requirements}
	...
	\begin{requirements}
		...
		\req[Spielfortschritt]{312} Man kann sehen wie viele Level, Levelpakte gemeistert wurden. Außerdem wird die Durchschnittliche Zeit pro Level angegeben.
