...
\begin{requirements}
	\req[Spielstufen] {F205} Die einzelnen Aufgaben sind in einem Levelsystem verbaut, dass  die verschiedenen Rätsel in größere Levelpakete zusammenfasst.
	\req [Levelpakete] {F207+} Innerhalb der Levelpakete ist der Fortschritt linear.
	...
	\req [Farben der Elemente] {F245} Der Spieler hat die Möglichkeit Alligatoren in bis zu 6 Farben einzufärben. Sollten durch den Ausdruck mehr benötigt werden unterstützt das Spiel bis zu 30 Farben, die dem Spieler jedoch nicht direkt zugänglich sind.
...
\begin {requirements}
	...
	\req [Ausblenden von Bedienelementen] {F425+}Elemente der Benutzeroberfläche, können in Situationen in denen sie nicht benötigt werden ausgeblendet sein.
	...
	Kompabilität mit dem Deutschen und mindesten einer weiteren Fremdsprache. Die Sprache wird vom System festgelegt, auf dem die App geöffnet wird.
	...
	\req[Einstellungen] Es gibt ein Menü in dem grundlegende Spieleigenschaften zentral umestellt werden können. 
		\begin{itemize}
			\item [+] Zoom Button
			\item [+] Rot-Grün Modus
			\item Lautstärke Effekte
			\item [+] Lautstärke Musik
		\end{itemize}
\end {requirements}
