...
\begin{requirements}
	...
	\begin{itemize}
		...
		\item Mehr als 30 verschiedene Farben werden beim Umfärben nicht benötigt.
	\end{itemize}
\end{requirements}
...
\begin {requirements}
	...
	\req[Single Touch]{F420} Es ist möglich, den gesamten Funktionsumfang der App zu nutzen, ohne mehr als einen Finger dazu zu benötigen.
