...
Ob er es ganz vom Spielfeld entfernen darf, wird mit dem Feld \strong{"'removable"'} gesagt.
...
.1 \strong{"'de{.}croggle"'} : Object - Namensraum.
	.2 \strong{"'packages"'} : Liste - Liste mit Repräsentationen von Paketen{.} Gewöhnlich nur ein Paket.
		.3 : Object - Das zur Datei gehörende Paket als JSON Objekt.
			...
			.4 \strong{"'dependencies"'} : Liste - Die Liste mit Abhängigkeiten.
...
\dirtree{%
.1 \strong{"'de{.}croggle"'} : Object - Namensraum.
	.2 \strong{"'levels"'} : Liste - Levelobjekte.
		.3 : Object - Darstellung einzelner Levels.
			...
			.4 \strong{"'hints"'} : Liste - Strings mit Pfaden zu Hilfegrafiken.
			.4 \strong{"'data"'} (multiple choice) : Object - Spezielle Daten für die einzelnen Leveltypen.
				.5 Daten für MC Levels
					...
					.6 \strong{"'answers"'} : Liste - Liste mit Board Objekten der möglichen Antworten.
				...
				.5 Daten für FE Levels.
					...
					.6 \strong{"'blocked colors"'} : Liste - Liste mit unsigned Integer Werten, die blockierte Farben beschreiben.
					.6 \strong{"'blocked types"'} : Liste - String Liste mit Namen von Elementtypen, die im Level nicht platzierbar sind (egg, colored alligator, aged alligator).
...
\dirtree{%
.1 : BoardObject - Objekte, die Konstellationen auf einem Spielfeld modellieren.
	.2 \strong{"'families"'} : Liste - Eine Liste mit sogenannten "'BoardObjects"'.
		.3 BoardObject Objekte.
			...
			.4 Die drei möglichen Typen von Board sind "'egg"', "'colored alligator"' und "'aged alligator"'.
				.5 Typ \strong{"'egg"'}.
					.6 \strong{"'color"'} : unsigned Integer - Die Identifikationsnummer der Farbe, die das Ei haben soll.
					.6 \strong{"'recolorable"'} : Bool - Ob das Objekt nachträglich vom Nutzer umgefärbt werden kann.
				.5 Typ \strong{"'colored alligator"'}.
					.6 \strong{"'color"'} : unsigned Integer - Die Identifikationsnummer der Farbe, die der Alligator haben soll.
					.6 \strong{"'recolorable"'} : Bool - Ob der Alligator nachträglich vom Nutzer umgefärbt werden kann.
					.6 \strong{"'children"'} : Liste - Eine Liste mit weiteren BoardObjects (Eier, Alligatoren\ldots{}), wie sie in diesem Listing beschrieben sind.
