...
public abstract class Parent {
	 ...
	 * @param child the child is the InternalBoardObject, which is added to the family of the parent
	 */
	 ...
	 * @param child the child is the InternalBoardObject, which is removed from the family of the parent
	 ...
	 * @param child the child is the InternalBoardObject which should be checked on
	 ...
	 * @param child the child is an InternalBoardObject in the children list
