...
/**
 * A visitor for traversing trees of BoardObjects.
 * It visits a node at first and then each of it's children from left to right.
 */
public interface BoardObjectVisitor {
	/**
	 * Called when an egg is visited.
	 *
	 * @param egg the egg which is visited
	 */
	 ...
	 *
	 * @param alligator the colored alligator which is visited
	 */
	 ...
	 *
	 * @param alligator the aged alligator which is visited
	 */
	 ...
	 *
	 * @param board the board which is visited
	 */
