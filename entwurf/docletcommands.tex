...
\pgfkeys{
	/texdocclass/.is family, /texdocclass,
	classtype/.value required,
	%~ classtype/.get=\classtype,
	classtype/.estore in=\classtype,
	classname/.value required,
	%~ classname/.get=\name,
	classname/.estore in=\name,
	%~ extends/.default=,
	%~ extends/.get=\extends,
	extends/.estore in=\extends,
	%~ implements/.default=,
	%~ implements/.get=\implements,
	implements/.estore in=\implements,
	%~ implements/.style=\StrSubstitute{#1}{;}{,},%Causes capacity exceeding. Don't know how to fix.
	default/.style = {extends =, implements =}
}
...
% Argument classtype: "class" or "interface"
% Argument classname: the name of the class/interface
% Argument extends [opt.]: the name of the superclass
% Argument implements [opt.]: the name of the realized interfaces
% TODO: Probably easier implementation with xparse instead of pgfkeys. Would make substitution ; <-> , unnecessary
\newenvironment{texdocclass}[1]{%
		\pgfkeys{/texdocclass, default, #1}
		\gdef\classname{\name}
		\subsection{\texttt{\classtype{} \textbf{\name{}}
		\if\extends\relax
		\else
			 extends \extends
		\fi
        ...
        %~ \subsection{\texttt{\classtype{}\textbf{\name{}} \ifthenelse{\equal{\extends{}}{}}{}{ extends \extends{}}\ifthenelse{\equal{\implements{}}{}}{}{implements \implements{}}}}
% }{\newpage{}}
}{}% removed \newpage
